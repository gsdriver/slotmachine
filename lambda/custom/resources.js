...
const resources = {
  'en-US': {
    'translation': {
      ...
      'LAUNCH_WELCOME_BUTTON': 'If you have an Echo Button, press it to play {Game} <break time=\"200ms\"/> You can also say spin to play {Game} or no to pick a different machine.',
      ...
      // From Spin.js
      'SPIN_YOU_BET': 'You bet {Amount}. ',
      'SPIN_RESULT': ' {Result}. ',
      'SPIN_PROGRESSIVE_WINNER': 'You hit the progressive jackpot and won {Amount}! ',
      'SPIN_WINNER': 'You matched {Match} and won {Amount}. |you won {Amount}. |that gives you {Amount}. |<break time=\"200ms\"/> winner winner chicken dinner! You\'re getting {Amount}. ',
      ...
      'LEADER_GAME_RANKING': 'Your current bankroll of {Coins} coins on {Game} ranks you as <say-as interpret-as="ordinal">{Rank}</say-as> of {Players} players. ',
